...
public:
    ...
    void greetings(){
        ...
        if (time-> tm_hour < 12){
            cout<< "Good Morning Master Thalesh Pal"<<endl;
            string phrase = "Good Morning Master Thalesh Pal";
            ...
            cout<< "Good Afternoon Master Thalesh Pal"<<endl;
            string phrase = "Good Afternoon Master Thalesh Pal";
            string command = "espeak \"" + phrase + "\"";
            const char *charCommand = command.c_str();
            system(charCommand);
        }
            ...
            cout<< "Good Evening Master Thalesh Pal"<<endl;
            string phrase = "Good Evening Master Thalesh Pal";
            string command = "espeak \"" + phrase + "\"";
            const char *charCommand = command.c_str();
            system(charCommand);
        }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Thalesh Pal|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Thalesh Pal";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="thalesh")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Thalesh ...."<<endl<<endl;

                string phrase = "How can i help you Master Thalesh Pal";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Thalesh Pal....."<<endl;
                    string phrase = "Hello Master Pal";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Thalesh Pal !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Thalesh Pal !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                //     const char *charCommand = command.c_str();
                //     system(charCommand);
                //     CreateProcess(TEXT("C:\\Program Files\\Microsoft Office\\root\\Office16"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                // }
                ...
                {
                    cout<<"Good Bye Master Thalesh Pal, see you soon!"<<endl;
                    string phrase = "Good Bye Master Thalesh Pal, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
